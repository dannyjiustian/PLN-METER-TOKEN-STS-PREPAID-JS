...
class DecoderKeyGenerator {
  constructor(
    vendingKey,
    keyType = "3",
    supplyGroupCode = "560983",
    tariffIndex = "01",
    keyRevisionNumber = "1",
    decoderReferenceNumber = "56728389217"
  ) {
    ...
    this.vendingKey = vendingKey; // THe vending key
  }
  ...
  generateDecoderKey() {
    ...
    const vendingKey = this.getVendingKey(); // Retrieve the vending key
...
// Export DecoderKeyGenerator as the default export
